<div class="container-fluid fh5co_footer_bg pb-3">
    <div class="container animate-box">
        <div class="row">
            <div class="col-12 spdp_right py-5"><img src="/assets/images/white_logo.png" alt="img"
            ...
            <div class="col-12 col-md-4 col-lg-4 position_footer_relative">
                ...
                <div class="footer_position_absolute"><img src="/assets/images/footer_sub_tipik.png" alt="img"
    ...
    <div class="container">
        <div class="row  ">
            ...
            <div class="col-12 col-md-6 spdp_right py-4">
                ...
                <a href="/blogs" class="footer_last_part_menu">Latest News</a>
            </div>
        </div>
    </div>
</div>
